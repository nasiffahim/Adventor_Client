...
import { Home, Users, MapPin, User, LogIn, LayoutDashboard, Bell, LogOut, Info } from "lucide-react";
    ...
    <div className="navbar text-white relative px-2 sm:px-4">
      ...
      <div className="navbar-start relative z-10 flex-1 min-w-0">
        <div className="dropdown">
          <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden hover:bg-white/20 transition-colors duration-300 btn-sm min-h-0 h-8 w-8 p-1">
            <svg
        ...
        <div className="flex-shrink-0">
          {user ? (
            ...
            <div>
              ...
              >
                <LogIn 
                  className="w-3 h-3 sm:w-4 sm:h-4 opacity-100 transition-all duration-300 transform group-hover:scale-110 flex-shrink-0" 
                />
                <span className="group-hover:translate-x-1 transition-transform duration-300 whitespace-nowrap">Log In</span>
              </Link>
            </div>
          )}
        </div>
